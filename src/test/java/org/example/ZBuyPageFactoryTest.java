...
public class ZBuyPageFactoryTest {
    @Test
    void buy() {
        ...
        ZBuyPageFactory buyPageFactory = new ZBuyPageFactory(driver);
        buyPageFactory.buyTicket();
        assertEquals("Ряд 11 / Место 1", driver.findElement(By.xpath("//div[contains(text(),'Ряд 11 / Место 1')]")).getText());
